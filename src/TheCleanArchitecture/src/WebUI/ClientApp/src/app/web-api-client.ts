...
export interface IGetTodosClient {
...
export class GetTodosClient implements IGetTodosClient {
    ...
    get(): Observable<TodosVm> {
        let url_ = this.baseUrl + "/api/GetTodos";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IExportTodosClient {
...
export class ExportTodosClient implements IExportTodosClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    get(id: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/ExportTodos/{id}";
...
export interface IUpdateTodoListClient {
...
export class UpdateTodoListClient implements IUpdateTodoListClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    update(id: number, command: UpdateTodoListCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/UpdateTodoList/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export interface IDeleteTodoListClient {
...
export class DeleteTodoListClient implements IDeleteTodoListClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    delete(id: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/DeleteTodoList/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export interface ICreateTodoListClient {
...
export class CreateTodoListClient implements ICreateTodoListClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    create(command: CreateTodoListCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/CreateTodoList";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IGetTodoItemsWithPaginationClient {
...
export class GetTodoItemsWithPaginationClient implements IGetTodoItemsWithPaginationClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export interface ICreateTodoItemClient {
...
export class CreateTodoItemClient implements ICreateTodoItemClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export interface IUpdateTodoItemDetailClient {
...
export class UpdateTodoItemDetailClient implements IUpdateTodoItemDetailClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    updateItemDetails(id: number | undefined, command: UpdateTodoItemDetailCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/todoItems/UpdateItemDetails?";
        if (id === null)
...
export interface IDeleteTodoItemClient {
    delete(id: number): Observable<FileResponse>;
}
...
export class DeleteTodoItemClient implements IDeleteTodoItemClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
