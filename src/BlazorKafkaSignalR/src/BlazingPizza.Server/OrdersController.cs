...
namespace BlazingPizza.Server
{
    ...
    public class OrdersController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult<int>> PlaceOrder(Order order, [FromServices] ICapPublisher capPublisher)
        {
            ...
            await capPublisher.PublishAsync("orders", new OrderPlacedEvent(order.OrderId));
